...
contract Trippy is Initializable, ERC20Upgradeable, OwnableUpgradeable {
     ...
     */
    function initialize(string memory name, string memory symbol, uint256 initialSupply, uint8 initialDecimals) external virtual initializer {
        ...
        numTokensSellToAddToLiquidity = 1000000000000000000000;
